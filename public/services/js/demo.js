        ...
        initEvents() {
            ...
            this.DOM.thumbs.forEach((thumb, pos) => {
                thumb.addEventListener('click', () => {
                    ...
                    this.showProject();
                    $('#imglogo').hide();
                    $('#rotate-left').fadeOut(600);
                    $('#rotate-right').fadeOut(600);
                    $('#imgname').fadeOut(600);
                    $('.content-hamburger').hide();
                    // document.getElementById("rotate-left").fadeOut();
                    // document.getElementById("rotate-right").fadeOut();
                    // document.getElementById("imgname").fadeOut();
                });
            });
            ...
            this.DOM.moreCtrl.addEventListener('click', () => {
                ...
                this.hideProject();
                $('#imglogo').show();
                $('.content-hamburger').show();
                $('#rotate-left').fadeIn(600);
                $('#rotate-right').fadeIn(600);
                $('#imgname').fadeIn(600);
            });
